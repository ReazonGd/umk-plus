import { Dayname, Schedule } from "@/types";
import { log } from "@/lib/debug-log";

export default async function getShedules(): Promise<Schedule[]> {
...
//   // TODO: Implement for new portalkawe website.. 
//   const kw_page = await fetch("https://portalkawe.umk.ac.id/mahasiswa/jadwal_ketrampilan");
...
//   const table_body = doc.querySelector("table tbody");

//   if (!table_body) {
//     log("table kw is not found. breaking...", "warn");
//     return [];
//   }
...
//       dosen: (row.children[2].textContent ?? "").trim(),
