...
UMK+ is a Chrome browser extension focused on UMK (Universitas Muria Kudus) students. Built with TypeScript, esbuild, and Preact to facilitate development.
...
- Drag and drop crx file to extension manager page.
